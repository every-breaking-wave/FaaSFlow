...
class FunctionManager:
    ...
    def allocate(self, request_id, workflow_name, function_name, function_info):
        self.templates[function_name].allocate(
            request_id, workflow_name, function_name, function_info
        )

    def send_data(self, request_id, workflow_name, function_name, datas, datatype):
        self.templates[function_name].send_data(
            request_id, workflow_name, function_name, datas, datatype
        )
    ...
    def allocate_block(
        ...
        self.templates[template_name].allocate_block(
            request_id,
            workflow_name,
            template_name,
            templates_infos,
    ...
    def preempt_block(
        ...
        return self.templates[template_name].preempt_block(
            request_id,
            workflow_name,
            template_name,
            buddy_block_name,
